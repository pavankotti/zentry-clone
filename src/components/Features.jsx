...
const BentoCard = ({ src, title, description }) => {
    return (
        <div className='relative size-full'>
            ...
            />
            <div className='relative z-10 size-full flex-col
            justify-between p-5 text-blue-50'>
                <div>
                    <h1 className='bento-title font-black'>{title}</h1>
                    {description &&(
            ...
            gap-7'>
                ...
                <BentoTilt className='bento-tilt_1 me-14 md:col-span-1 md:me-0'>
                    <BentoCard
                        ...
                        title={<>az<b>u</b>l</>}
                        description="A cress-world AI Agebt - elevating your
                ...
                <div className='bento-tilt_2'>
                    ...
                    bg-violet-300 p-5'>
                        ...
                        text-clack'>M<b>o</b>re co<b>m</b>ing s<b>o</b>on!</h1>
